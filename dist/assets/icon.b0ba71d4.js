import{ar as c,cs as h,ct as o,cu as e,cv as p,cw as n,cx as i,cy as m,cz as f,cA as d,cB as F,cC as v,cD as E,cE as u,cF as M}from"./index.124d7191.js";import{d as B,f as H,g as I,h as V}from"./index.47a4ef2c.js";import{j as x}from"./useTitle.2c9e45b2.js";import{I as A}from"./Layout.b6c0d646.js";import{a as k}from"./index.3e2567d7.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function z(a){return c({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>`},a)}function D(a){return c({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#909090"
  ...
  ></path>F`},a)}function U(a){return c({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const L={"dmg,ipa,plist,tipa":m,"exe,msi":f,"zip,gz,rar,7z,tar,jar,xz":d,apk:A,db:B,md:F,epub:H,iso:I,m3u8:i,"doc,docx":v,"xls,xlsx":E,"ppt,pptx":u,pdf:M,psd:z,ai:D,url:V,cast:k},Z=(a,t)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(t.toLowerCase()))return r}switch(a){case l.FOLDER:return x;case l.VIDEO:return i;case l.AUDIO:return n;case l.TEXT:return p;case l.IMAGE:return e;default:return o}},O=a=>Z(a.type,h(a.name));export{U as A,l as O,O as g};
